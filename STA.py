...
# size=len(puiss)
# #vect_1,n=vect_detect_pic(charO,charA,T,opt='ripples',fact=2,max_fact=10,h=1)
# #size=len(vect_1)
# # print("size",size)
# X=np.zeros((2,size))
...
# liste_t=detec_pic(charB,,T,opt='ripples',fact=5,max_fact=10,h=1)[0] #contains tmax of sharpw detection

def STA_dt_before(liste_t,X,dt=128):
    """Spike triggered average
    Gives the value of the average xi for a window of 500ms before the detection of sharw
    liste_t : list of time containing the sharpw
