...
# x4[:,0:2]=x
# x4[:,2:4]=x2
# neural_gas = algorithms.GrowingNeuralGas(n_inputs=4,shuffle_data=True,verbose=True, max_edge_age=10, n_iter_before_neuron_added=50,max_nodes=100)
# neural_gas.train(x4,epochs=100)
